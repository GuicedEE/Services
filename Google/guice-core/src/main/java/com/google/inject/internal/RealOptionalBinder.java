...
public final class RealOptionalBinder<T> implements Module {
  ...
  @SuppressWarnings("unchecked")
  static <T> TypeLiteral<Optional<Provider<T>>> optionalOfJakartaProvider(
      TypeLiteral<T> type) {
  ...
  @SuppressWarnings("unchecked")
  static <T>
      TypeLiteral<java.util.Optional<Provider<T>>> javaOptionalOfJakartaProvider(
          TypeLiteral<T> type) {
  ...
  public void configure(Binder binder) {
    ...
    // Provider is assignable to Provider and the provider that the factory contains
