...
public interface MapBinderBinding<T> {
   ...
   * {@code Map<K, com.google.inject.Provider<V>>}, {@code Map<K, Provider<V>>}, {@code
   * Map<K, Set<com.google.inject.Provider<V>>>}, {@code Map<K, Set<Provider<V>>>},
   * {@code Map<K, Collection<com.google.inject.Provider<V>>>}, {@code Map<K,
   * Collection<Provider<V>>>}, {@code Map<K, Set<V>}, and {@code Map<K, ? extends V>}.
   *
   * @since 4.2.3
   */
