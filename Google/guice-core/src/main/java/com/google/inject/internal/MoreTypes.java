...
public class MoreTypes {
   ...
   *
   * <p>If the raw type of {@code typeLiteral} is a {@code Provider} or {@code
   * Provider}, this returns a {@code com.google.inject.Provider} with the same type
   * parameters.
   *
