 ...
 * Provides Provides} bindings can be exposed with the {@literal @}{@link Exposed}
 * annotation:
 *
 * <pre>
...
public abstract class PrivateModule implements Module {
  ...
  /**
   * @see Binder#bindInterceptor(Matcher,
   *     Matcher, MethodInterceptor[])
   */
  ...
  /**
   * @see Binder#convertToTypes(Matcher,
   *     TypeConverter)
   */
