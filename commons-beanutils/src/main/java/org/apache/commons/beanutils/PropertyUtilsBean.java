...
public class PropertyUtilsBean {
    ...
    private ConcurrentHashMap<Class<?>, ConcurrentHashMap> mappedDescriptorsCache = null;
    ...
    public PropertyUtilsBean() {
        descriptorsCache = new ConcurrentHashMap<Class<?>, BeanIntrospectionData>();
        mappedDescriptorsCache = new ConcurrentHashMap<Class<?>, ConcurrentHashMap>();
