...
public class LocaleConvertUtilsBean {
     ...
     */
    private final ConcurrentHashMap mapConverters = new ConcurrentHashMap();
   ...
   public Object convert(final String[] values, final Class<?> clazz) {
    ...
    public void deregister() {
        ...
        final ConcurrentHashMap defaultConverter = lookup(defaultLocale);
     ...
     */
    @Deprecated
    protected ConcurrentHashMap lookup(final Locale locale) {
        ConcurrentHashMap localeConverters;

        if (locale == null) {
            localeConverters = (ConcurrentHashMap) mapConverters.get(defaultLocale);
        }
        else {
            localeConverters = (ConcurrentHashMap) mapConverters.get(locale);
     ...
     */
    @Deprecated
    protected ConcurrentHashMap create(final Locale locale) {

        final ConcurrentHashMap converter = new ConcurrentHashMap();
