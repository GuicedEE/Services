 ...
 * classes.
 * <p>
 * In the case of a the {@link jakarta.cache.annotation.CacheResult} annotation,
 ...
 * {@link jakarta.cache.annotation.CacheResult} the annotation allows the cached
 * value to be mutated so that it will be correct the next time
 * {@link jakarta.cache.annotation.CacheResult} is used.
 * <p>
 * Any operations against a cache via an annotation will have the same behaviour
 * as if the {@link jakarta.cache.annotation.CacheResult} methods were used. So
