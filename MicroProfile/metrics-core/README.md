...
JDK using Jandex on the CLI:
 ...
 ```
$ java -jar target/jandex-2.0.2-SNAPSHOT.Alpha1.jar hibernate-core-4.0.0.Final.jar
...
$ java -jar target/jandex-2.0.2-SNAPSHOT.Alpha1.jar rt.jar
...
```xml
 <dependency>
     ...
     <version>2.0.2-SNAPSHOT.Final</version><type>jar</type>
            </dependency>
```
