...
public class SerialPort
{
    ...
    static public SerialPort[] getCommPorts()
    {
        ...
        try
        {
            return isAndroid ? AndroidPort.getCommPortsNative() : getCommPortsNative();
        } finally
        {
            libraryLock.unlock();
        }
    ...
    {
        return (portHandle != 0) ? ((androidPort != null) ? androidPort.bytesAvailable() : bytesAvailable(portHandle)) : -1;
    }
    ...
    {
        return (portHandle != 0) ? ((androidPort != null) ? androidPort.bytesAwaitingWrite() : bytesAwaitingWrite(portHandle)) : -1;
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.setBreak() : setBreak(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.clearBreak() : clearBreak(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getCTS() : getCTS(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getDSR() : getDSR(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getDCD() : getDCD(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getDTR() : getDTR(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getRTS() : getRTS(portHandle));
    }
    ...
    {
        return (portHandle != 0) && ((androidPort != null) ? androidPort.getRI() : getRI(portHandle));
    }
    ...
    private final class SerialPortEventListener
    {
        ...
        public SerialPortEventListener()
        {
            ...
            delimiters = new byte[0];
            messageEndIsDelimited = true;
        }
        ...
        public SerialPortEventListener(byte[] messageDelimiters, boolean delimiterForMessageEnd)
        {
            ...
            messageEndIsDelimited = delimiterForMessageEnd;
        }
