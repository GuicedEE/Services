 ...
 * Every kind of markup element in Facelets VDL that has attributes that need to take action on a javax Server Faces
 * Java API artifact is associated with an instance of this class. This class is an abstraction to enable a rule based
 * method for directing how different kinds of elements take different kinds of actions in the javax Server Faces Java
 ...
 *
 * <p>
 * This markup element corresponds to an instance of {@link javax.faces.component.html.HtmlInputText} in the view.
 * <code>HtmlImputText</code> has a number of attributes that are to be exposed to the page author.
 * <code>HtmlInputText</code> also implements {@link javax.faces.component.EditableValueHolder}, which extends
 * {@link javax.faces.component.ValueHolder}. Each of these interfaces also expose a number of attributes to the page
 * author.
 * </p>
 *
 * <p>
 * Facelets employes the strategy pattern to allow the manner in which all possible attributes are handled based on the
 * nature of the javax Server Faces Java API artifact associated with the markup element.
 * </p>
 *
 * <p>
