 ...
 * <span class="changed_deleted_2_2">Deprecated as of javax Server Faces 2.2. The same functionality is more correctly
 * provided by {@link javax.faces.application.ResourceHandler}.</span> Provide a hook to decorate or override the way
 * that Facelets loads template files. A default implementation must be provided that satisfies the requirements for
 * loading templates as in Pre-javax Server Faces 2.0 Facelets.
 * </p>
 *
