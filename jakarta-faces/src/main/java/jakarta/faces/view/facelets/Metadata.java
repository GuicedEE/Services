 ...
 * There are concrete subclasses within the implementation that map concepts in the Facelet VDL page to javax Server
...
public abstract class Metadata {
    ...
    /**
     * <p class="changed_added_2_0">
     * Take the action prescribed in the javax Server Faces specification for this particular VDL element attribute.
     * </p>
     *
     * @param ctx The FaceletContext for this request.
     * @param instance The instance from the javax Server Faces Java API on which the action should be taken. For example,
     * an instance of {@link javax.faces.component.EditableValueHolder}.
     */
