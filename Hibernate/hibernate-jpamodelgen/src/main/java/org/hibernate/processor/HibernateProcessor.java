...
public class HibernateProcessor extends AbstractProcessor {
    ...
    private void processClasses(RoundEnvironment roundEnvironment) {
        ...
        for ( Element element : roundEnvironment.getRootElements() ) {
            if (element == null)
            {
                System.out.println("Element is null - " + roundEnvironment.getRootElements());
                continue;
            }
            try {
...
//						}
    ...
    private Metamodel tryGettingExistingEntityFromContext(TypeElement typeElement, String qualifiedName) {
