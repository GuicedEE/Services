...
public class JarFileBasedArchiveDescriptor extends AbstractArchiveDescriptor
{
	...
	public void visitArchive(ArchiveContext context)
	{
		...
		try
		{
			...
			java.nio.file.Files.walkFileTree(path, new JRTModuleWalker());
		}
	...
	/**
	 * Peruses through the modular file system, finding anything applicable in modules that have opened access to the module org.hibernate.orm (this)
